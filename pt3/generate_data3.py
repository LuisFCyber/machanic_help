...
cars_def = {
    ...
    "Fiat": [
        ...
        ("mobi", "Mobi 1.0", "Subcompacto urbano acessível.", "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&q=80&w=800")
    ],
    "Volkswagen": [
        ...
        ("virtus", "Virtus 1.0 TSI", "Sedã com enorme porta-malas.", "https://images.unsplash.com/photo-1550346338-71e860bc8153?auto=format&fit=crop&q=80&w=800")
    ],
    "Ford": [
    ...
    "Hyundai": [
        ...
        ("tucson", "Tucson 1.6 Turbo", "SUV de grande conforto e espaço.", "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800")
    ],
    "Toyota": [
        ...
        ("yaris", "Yaris 1.3/1.5", "Hatch premium confortável.", "https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&q=80&w=800")
    ],
    "Honda": [
        ("civic", "Civic 2.0 / 1.5T", "Sedã esportivo e dinâmico.", "https://images.unsplash.com/photo-1532986422792-7efc90066b26?auto=format&fit=crop&q=80&w=800"),
        ("hrv", "HR-V 1.8 / 1.5T", "SUV líder em confiabilidade.", "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800"),
        ("fit", "Fit 1.5", "Carro prático e excelente no espaço interno.", "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&q=80&w=800"),
        ("city", "City 1.5", "Sedã compacto ideal para família.", "https://images.unsplash.com/photo-1550346338-71e860bc8153?auto=format&fit=crop&q=80&w=800")
    ],
    "Jeep": [
        ("renegade", "Renegade 1.8 / 1.3T", "SUV com DNA off-road e robustez.", "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800"),
        ("compass", "Compass 2.0", "SUV médio mais desejado do Brasil.", "https://images.unsplash.com/photo-1633505584501-f1ebbd15cd47?auto=format&fit=crop&q=80&w=800")
    ],
    "Nissan": [
        ("kicks", "Kicks 1.6", "Crossover urbano e econômico.", "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800"),
        ("versa", "Versa 1.6", "Sedã compacto muito espaçoso.", "https://images.unsplash.com/photo-1590362891991-f776e747a588?auto=format&fit=crop&q=80&w=800"),
        ("frontier", "Frontier 2.3 Diesel", "Picape de carga muito resistente.", "https://images.unsplash.com/photo-1559404047-927b5e43a8ce?auto=format&fit=crop&q=80&w=800")
    ],
    "Renault": [
        ("kwid", "Kwid 1.0", "O SUV dos compactos.", "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&q=80&w=800"),
        ("duster", "Duster 1.6", "SUV robusto para qualquer terreno.", "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800"),
        ("sandero", "Sandero 1.0/1.6", "Espaçoso e manutenção simples.", "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&q=80&w=800")
    ]
}
